...
<head>
    ...
    <title>Add User - Biometric System</title>
        ...
        <header class="bg-white shadow-sm border-b">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center py-6">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">Add Biometric User</h1>
                        <p class="mt-2 text-sm text-gray-600">Create a new user and link device ID with employee information</p>
                    </div>
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="bg-white shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <form method="POST" action="{{ route('biometric.users.store') }}" class="space-y-6">
                        @csrf
